...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_example(episode_path, demo_id):
        ...
        command = "Assembly one square table leg onto a square table top."
...
class FURBENOneLeg(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data2/lzixuan/furniture-bench/scripted_sim_demo/one_leg/*/*.pkl"),
        }
