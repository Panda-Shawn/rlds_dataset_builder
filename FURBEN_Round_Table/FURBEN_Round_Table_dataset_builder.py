...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_example(episode_path, demo_id):
        ...
        command = "Assembly a round table with a round table top, a round table leg, and a round table base."
...
class FURBENRoundTable(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data2/lzixuan/furniture-bench/scripted_sim_demo/round_table/*/*.pkl"),
        }
