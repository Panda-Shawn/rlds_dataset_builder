...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_example(episode_path, demo_id):
        ...
        command = "Assembly a cabinet with a cabinet body, a cabinet top, and two cabinet doors."
...
class FURBENCabinet(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            "train": glob.glob("/data2/lzixuan/furniture-bench/scripted_sim_demo/cabinet/*/*.pkl"),
        }
